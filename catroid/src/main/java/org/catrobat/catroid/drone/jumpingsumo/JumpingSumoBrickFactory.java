...
public final class JumpingSumoBrickFactory {
	...
	public enum JumpingSumoBricks {
		JUMPING_SUMO_ANIMATIONS, JUMPING_SUMO_FORWARD, JUMPING_SUMO_BACKWARD, JUMPING_SUMO_NO_SOUND,
		JUMPING_SUMO_SOUND, JUMPING_SUMO_JUMP_LONG, JUMPING_SUMO_JUMP_HIGH, JUMPING_SUMO_ROTATE_LEFT,
		JUMPING_SUMO_ROTATE_RIGHT, JUMPING_SUMO_TURN, JUMPING_SUMO_PICTURE
	}
